  ...
  <div class="sidebar">
    ...
    <section class="home-section">
        ...
        <div class="sidebar-button">
            ...
            <span class="dashboard">Edit Data Products</span>
        </div>
        ...
        <div class="container">
            ...
            <form action="edits.php" method="POST">
                ...
                <div class="input-box">
                    ...
                    <input type="text" placeholder="Masukkan Nama Barang" name="namabarang"  value="<?php echo
                    $barang['namabarang'] ?>" required>
                </div>
                <div class="input-box">
                    <span class="details">Quantity</span>
                    <input type="text" placeholder="Masukkan Quantity" name="qty" value="<?php echo
                $barang['qty'] ?>" required>
                </div>
                <div class="input-box">
                    <span class="details">Kategori</span>
                    <select class="form-control" id="details" name="kategori"  value="<?php echo
                $barang['kategori'] ?>" required>
                ...
                <div class="input-box">
                    ...
                    <input type="text" placeholder="Masukan Harga" name="harga"  value="<?php echo
                $barang['harga'] ?>"required>
                </div>
                <div class="input-box">
                    <span class="details">Keterangan</span>
                    <textarea class="form-control" id="details" rows="3" name="keterangan"  value="<?php echo
                $barang['keterangan'] ?>"></textarea>
                </div>
                
                </div>
                <div class="gender-details">
                <input type="radio" name="ketstok" id="dot-1"  value="<?php echo
                $barang['ketstok'] ?>">
                <input type="radio" name="ketstok" id="dot-2"  value="<?php echo
                $barang['ketstok'] ?>">
